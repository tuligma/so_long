...
#    Updated: 2024/07/15 13:34:36 by npentini         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = so_long
SRCS = so_long.c so_long_misc.c so_long_print.c so_long_error.c so_long_error_func1.c so_long_error_func2.c so_long_free.c
LIBFT_PATH = ./libft
